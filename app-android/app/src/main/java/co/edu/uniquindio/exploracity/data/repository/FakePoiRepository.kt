...
val samplePois: List<Poi> = listOf(
    poi("cafe-las-acacias", "Café Las Acacias", GASTRONOMY, 4.6383, -74.0655, 48, 12, price = 1, openNow = true, summary = "Tostión propia y patio interior, ideal en la mañana."),
    poi("museo-barrio-egipto", "Museo del Barrio Egipto", CULTURE, 4.5925, -74.0675, 132, 31, price = 1, openNow = true, summary = "Memoria del barrio contada por sus vecinos."),
    ...
    poi("la-puerta-falsa", "La Puerta Falsa", GASTRONOMY, 4.5977, -74.0746, 164, 52, price = 1, openNow = true, summary = "Tamales y chocolate con queso desde 1816."),
    poi("casa-independencia", "Casa de la Independencia", HISTORY, 4.5985, -74.0753, 58, 9, price = 1, summary = "El florero de Llorente y el 20 de julio de 1810.", finalized = true),
    poi("teatro-colon", "Teatro Colón", ENTERTAINMENT, 4.5961, -74.0735, 96, 17, price = 3, openNow = false, summary = "Teatro nacional con temporada de ópera y danza."),
    poi("museo-del-oro", "Museo del Oro", CULTURE, 4.6019, -74.0721, 301, 88, price = 1, openNow = true, summary = "La mayor colección de orfebrería prehispánica."),
    poi("museo-botero", "Museo Botero", CULTURE, 4.5967, -74.0730, 187, 40, openNow = true, summary = "Obras donadas por Fernando Botero; entrada libre."),
    ...
    poi("mercado-paloquemao", "Mercado de Paloquemao", GASTRONOMY, 4.6155, -74.0838, 119, 35, price = 1, openNow = true, summary = "Frutas, flores y desayunos de plaza de mercado."),
    poi("quinta-de-bolivar", "Quinta de Bolívar", HISTORY, 4.6030, -74.0648, 64, 8, price = 1, openNow = true, summary = "Casa y jardines donde vivió Simón Bolívar."),
    poi("cerro-monserrate", "Cerro de Monserrate", NATURE, 4.6058, -74.0556, 256, 73, price = 2, openNow = true, summary = "Vista de toda la ciudad; se sube a pie o en funicular."),
    ...
    poi("taller-de-mascaras", "Taller de máscaras", CULTURE, 4.6440, -74.0630, 22, 4, price = 2, openNow = false, summary = "Talleres de máscaras de carnaval los sábados."),
    poi("galeria-santa-fe", "Galería Santa Fe", CULTURE, 4.6123, -74.0689, 18, 3, openNow = true, summary = "Arte emergente en el Planetario."),
    poi("parque-de-la-93", "Parque de la 93", ENTERTAINMENT, 4.6766, -74.0485, 91, 20, price = 3, summary = "Restaurantes y eventos al aire libre."),
    ...
    poi("tienda-don-alvaro", "Tienda de don Álvaro", GASTRONOMY, 4.6300, -74.0790, 29, 7, price = 1, openNow = true, summary = "Empanadas y tinto de barrio."),
    poi("jardin-botanico", "Jardín Botánico José Celestino Mutis", NATURE, 4.6687, -74.0999, 178, 39, price = 1, openNow = true, summary = "Colecciones de flora andina y de páramo."),
    ...
    poi("pulgas-usaquen", "Mercado de las pulgas de Usaquén", GASTRONOMY, 4.6948, -74.0307, 88, 21, price = 2, openNow = false, summary = "Artesanías y comida los domingos."),
